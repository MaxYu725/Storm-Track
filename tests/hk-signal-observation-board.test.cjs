...
const boardApi = require('../analysis/hk-signal-observation-board.js');
...
const board = boardApi.deriveObservationBoard({ records: [dirty, clean1, clean2, narra], caseIndex });
...
assert.ok(Math.abs(gaenari.latest.deltas.t1RiskIndex - 0.06) < 1e-12);
...
assert.equal(boardApi.observationPath('2026-08-22T01:37:22.817Z', '9e6b3cd71895abcdef'), 'observations/2026/08/22/20260822T013722Z-9e6b3cd71895.json');
